...
navigation = st.navigation(
    {
        "发车": [
            st.Page(render_home_page, title="发车助手", icon="📝", default=True),
        ],
        "战绩": [
            st.Page("pages/1_数据大厅.py", title="数据大厅", icon="📊", url_path="数据大厅"),
            st.Page("pages/2_战绩管理.py", title="战绩管理", icon="🗂️", url_path="战绩管理"),
            st.Page("pages/3_对局明细.py", title="对局明细", icon="🔎", url_path="对局明细"),
        ],
    },
    expanded=True,
)
